@php
    ...
    $title = is_string($howTitle ?? null) ? $howTitle : config('cebinova.page.how_title');
    $text = is_string($howText ?? null) ? $howText : config('cebinova.page.how_text');
@endphp
...
<section class="section-pad bg-white" id="how-it-works">
    <div class="container-wide">
        ...
        <ol class="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
            @foreach (config('cebinova.process') as $item)
